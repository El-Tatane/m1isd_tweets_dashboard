...
def route_index(**args):
    ...
    mod.insert_double_element("h1", "<center>Tweet Filters</center>")
    mod.insert_simple_element("br")
    mod.insert_simple_element("input placeholder='username' id='user_name' type='text'")
    mod.insert_raw_html("<span>  separor : ,  (OR condition) </span>")
    mod.insert_simple_element("br")
    ...
    mod.insert_raw_html("<span> Format date : jj/mm/aaaa hh:mm</span>")
    mod.insert_simple_element("br")
    mod.insert_simple_element("br")
